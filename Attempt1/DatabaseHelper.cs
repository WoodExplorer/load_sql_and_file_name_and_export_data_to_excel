...
namespace Attempt1
{
    class DatabaseHelper
    {
        ...
        public static IDbConnection oracleConnection;
        ...
        {
            using (System.Data.IDbCommand iCmd = GetCommand(SqlString, oracleConnection))
            {
                try
                {
        ...
        public void ExecuteSqlTran(ArrayList SQLStringList)
        {
            ...
            {
                iCmd.Connection = oracleConnection;
                using (System.Data.IDbTransaction iDbTran = oracleConnection.BeginTransaction())
                {
        ...
        public IDataAdapter ExecuteReader(string strSQL)
        {
            try
            {
                System.Data.IDataAdapter iAdapter = this.GetAdapater(strSQL, oracleConnection);
                return iAdapter;
            }
            catch (System.Exception e)
            {
        ...
        public DataSet Query(string sqlString)
        {
            using (System.Data.IDbCommand iCmd = GetCommand(sqlString, oracleConnection))
            {
                ...
                try
                {
                    System.Data.IDataAdapter iAdapter = this.GetAdapater(sqlString, oracleConnection);
                    iAdapter.Fill(ds);
                    return ds;
                }
                catch (System.Exception ex)
        ...
        public DataTable ExecuteQuery(string SqlString, string Proc)
        {
            using (System.Data.IDbCommand iCmd = GetCommand(SqlString, oracleConnection))
            {
                ...
                try
                {
                    System.Data.IDataAdapter iDataAdapter = this.GetAdapater(SqlString, oracleConnection);
        ...
        {
            using (System.Data.IDbCommand iCmd = GetCommand(Sql, oracleConnection))
            {
                DataSet ds = new DataSet();
                try
                {
                    System.Data.IDataAdapter iDataAdapter = this.GetAdapater(Sql, oracleConnection);
                    iDataAdapter.Fill(ds);
        ...
        public int ExecuteSql(string SQLString, params IDataParameter[] iParms)
        {
            System.Data.IDbCommand iCmd = GetCommand();
            {
                try
                {
                    PrepareCommand(out iCmd, oracleConnection, null, SQLString, iParms);
                    int rows = iCmd.ExecuteNonQuery();
        ...
        {
                using (IDbTransaction iTrans = oracleConnection.BeginTransaction())
                {
                    System.Data.IDbCommand iCmd = GetCommand();
                    try
                    {
                    ...
                    foreach (DictionaryEntry myDE in SQLStringList)
                    {
                        ...
                        PrepareCommand(out iCmd, oracleConnection, iTrans, cmdText, iParms);
        ...
        public DataSet Query(string sqlString, params IDataParameter[] iParms)
        {
            IDbCommand iCmd = GetCommand();
            {
                ...
                try
                {
                    IDataAdapter iAdapter = this.GetAdapater(sqlString, oracleConnection);
                    DataSet ds = new DataSet();
                    iAdapter.Fill(ds);
                    iCmd.Parameters.Clear();
                    return ds;
        ...
        private void PrepareCommand(out IDbCommand iCmd, IDbConnection iConn,
            System.Data.IDbTransaction iTrans, string cmdText, IDataParameter[] iParms)
        {
        ...
        {
            using (SqlCommand sqlCmd = BuildQueryCommand(oracleConnection, storedProcName, parameters))
            {
        ...
        public DataSet RunProcedure(string storedProcName, IDataParameter[] parameters, string tableName)
        {
            ...
            iDA = this.GetAdapater(BuildQueryCommand(oracleConnection, storedProcName, parameters));
        ...
        /// <param name="pageSize">页面记录大小</param>
        /// <returns>DataSet</returns>
        public DataSet RunProcedure(string storedProcName, IDataParameter[] parameters, int startIndex,
        ...
        {
            System.Data.IDataAdapter iDA = this.GetAdapater();
            iDA = this.GetAdapater(BuildQueryCommand(oracleConnection, storeProcName, parameters));
            ((SqlDataAdapter)iDA).Fill(dataSet, tableName);
        ...
        public int RunProcedureNoQuery(string storedProcName, IDataParameter[] parameters)
        {
            ...
            using (SqlCommand scmd = BuildQueryCommand(oracleConnection, storedProcName, parameters))
            {
        ...
        public string RunProcedureExecuteScalar(string storeProcName, IDataParameter[] parameters)
        {
            ...
            using (SqlCommand scmd = BuildQueryCommand(oracleConnection, storeProcName, parameters))
            {
        ...
        {
            int result;
            using (SqlCommand sqlCmd = BuildIntCommand(oracleConnection, storedProcName, parameters))
            {
